...
// 히스토그램 직사각형 최대 넓이 구하기
class Histogram{
    public int height;    // 히스토그램의 높이
    public int leftX;     // 인덱스 혹은 히스토그램의 왼쪽 변의 x 좌표
    public int rightX;    // 히스토그램의 오른쪽 변의 x좌표
